...
import getYearlyStatsBDM from '@salesforce/apex/SPMController.getYearlyStatsBDM';
import { showError, showSuccess, nFormatter } from "c/spm_utility";

export default class Spm_bdd_year_summary extends LightningElement {
    ...
    get columns() {
        let columnList = [
            ...
            { label: "Open Actuals", fieldName: "OpenActual", displayColumn: true, type: "currency", sortable: true, cellAttributes: { alignment: 'center', iconName: { fieldName: 'trendIcon' }, iconPosition: 'center', class: 'slds-text-wrap' }, typeAttributes: {}, header: false },
            { label: "Invoiced Actuals", fieldName: "Actual", displayColumn: true, type: "currency", sortable: true, cellAttributes: { alignment: 'center', iconName: { fieldName: 'trendIcon' }, iconPosition: 'center', class: 'slds-text-wrap' }, typeAttributes: {}, header: false },
    ...
    @wire(getYearlyStatsBDM, { financialYear: '$financialYear', currentUser: '$currentBDD', selectedUser: '$selectedBDM' })
