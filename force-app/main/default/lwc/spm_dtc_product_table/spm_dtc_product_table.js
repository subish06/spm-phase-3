...
import getBusUnitProducts from '@salesforce/apex/DemoMonth.getBusUnitProducts';
import prepareBUProducts from '@salesforce/apex/DemoMonth.prepareBUProducts';
import upsertOrdCommit from '@salesforce/apex/DemoMonth.upsertOrdCommit';

import { showError, showSuccess, nFormatter } from "c/spm_utility";

export default class Spm_dtc_product_table extends LightningElement {
    ...
    get columns() {
        ...
        let columnList = [
            ...
            { label: 'Qty', fieldName: 'ordCommitsQuantity', type: 'number', editable: isEditMode, hideDefaultActions: true, sortable: "true" },
            ...
            { label: 'Invoiced Order Qty', fieldName: 'invoicedQty', type: 'number', hideDefaultActions: true, sortable: "true" },
            { label: 'Invoiced Order Amt', fieldName: 'invoicedPrice', type: 'currency', hideDefaultActions: true, sortable: "true" },
            { label: 'Open Order Qty', fieldName: 'openQty', type: 'number', hideDefaultActions: true, sortable: "true" },
    ...
    editDisabled() {
        ...
        return this.isEditMode && this.commitmentAvailable; //&& !this.hideButton
    }
