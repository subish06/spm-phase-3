...
import getTargetQuatBDM from '@salesforce/apex/SPMController.getTargetQuatBDM';
import getActualQuatBDM from '@salesforce/apex/SPMController.getActualQuatBDM';
import getVarianceQuatBDM from '@salesforce/apex/SPMController.getVarianceQuatBDM';


import { showError, showSuccess, nFormatter } from "c/spm_utility";

export default class Spm_bdd_quarter_summary extends LightningElement {
    ...
    @wire(getTargetQuatBDM, { financialYear: '$financialYear', currentUser: '$currentBDD', selectedUser: '$selectedBDM' })
    ...
    @wire(getActualQuatBDM, { financialYear: '$financialYear', currentUser: '$currentBDD', selectedUser: '$selectedBDM' })
    ...
    @wire(getVarianceQuatBDM, { financialYear: '$financialYear', currentUser: '$currentBDD', selectedUser: '$selectedBDM' })
