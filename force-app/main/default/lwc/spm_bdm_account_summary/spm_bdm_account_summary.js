...
import getTargetBDM from '@salesforce/apex/BDMController.getTargetBDM';
import getActualTarget from '@salesforce/apex/BDMController.getActualsBDM';
import getVarianceBDM from '@salesforce/apex/BDMController.getVarianceBDM';
import getBusinessUnits from '@salesforce/apex/BDMController.getBusinessUnits';
...
export default class Spm_bdm_account_summary extends LightningElement {
    ...
    @wire(getTargetBDM, { financialYear: '$financialYear', accountId: '$selectedAccount', currentUser: '$currentBDM' })
    ...
    @wire(getActualTarget, { financialYear: '$financialYear', accountId: '$selectedAccount', currentUser: '$currentBDM' })
    ...
    @wire(getVarianceBDM, { financialYear: '$financialYear', accountId: '$selectedAccount', currentUser: '$currentBDM' })
    ...
    downloadCSV() {
        ...
        downloadTargetCommitStats({ accountId: this.selectedAccount, selectedUser: this.currentBDM, financialYear: this.financialYear, businessUnitName : null })
            .then(result => {
