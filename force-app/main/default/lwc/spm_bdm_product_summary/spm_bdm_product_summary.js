...
import getBusUnitTarActVar from '@salesforce/apex/BDMController.getBusUnitTarActVar';
import getMonthTarActVar from '@salesforce/apex/BDMController.getMonthTarActVar';
import MonthTarActVar from '@salesforce/apex/BDMController.MonthTarActVar';
import getBusUnitProducts from '@salesforce/apex/BDMController.getBusUnitProducts';
import downloadTargetCommitStats from '@salesforce/apex/BDMController.downloadTargetCommitStats';
import updateTargetCommit from '@salesforce/apex/BDMController.updateTargetCommit';
...
export default class Spm_bdm_product_summary extends LightningElement {
    ...
    //         selectedMonth: this.selectedMonth, ProdCode: this.prodCode, ProdDescription: this.prodDescription
    //     })
    //         .then((data) => {
    //             console.log('data===>',data)
    //             this.busUnitProductData = [];
    //             let initialBusUnitData = {
    //                 "Product Code" : '',
    //                 "Description": '',
    //                     // "Finish": '',
    //                 "Quantity": 0,
    ...
    //                 console.log('busUnitdata[busUnit]===>',data[busUnit])

    //                 let busUnitData = {
    //                     "Product Code" : data[busUnit].productCode,
    //                     "Description": data[busUnit].description,
    //                     // "Finish": data[busUnit].finish,
    //                     "Quantity": data[busUnit].ordCommitsQuantity,
    //                     "Unit Price": data[busUnit].ordCommitsUnitPrice,
    //                     "Committed Order": data[busUnit].committedOrder
    //                 };

    //                 this.busUnitProductData.push(busUnitData);
    //                 // console.log('busUnitProductData12===>',this.busUnitProductData)
    //             }

    //             let rowEnd = '\n';
    //             let csvString = '';

    //             let rowData = Object.keys(this.busUnitProductData[0]);
    //             csvString += rowData.join(',') + rowEnd;

    //             for (let i = 0; i < this.busUnitProductData.length; i++) {
    //                 let colValue = 0;
    ...
    //                         let value = this.busUnitProductData[i][rowKey] === undefined ? '' : this.busUnitProductData[i][rowKey];
    //                         csvString += value;
    //                         colValue++;
    //                     }
    //                 }
    ...
    //             downloadElement.download = 'Product_Data.csv';
    ...
    downloadCSV() {
        ...
        downloadTargetCommitStats({ accountId: this.accountId, selectedUser: this.currentBDM, financialYear: this.financialYear, businessUnitName : this.busUnitName })
            .then(result => {
    ...
    openUploadDialog() {
        pendingTargetUpload({ currentUser: this.currentBDM })
            .then(result => {
