...
import getBDMAccountStats from '@salesforce/apex/BDMController.getBDMAccountStats';
import { showError, nFormatter } from "c/spm_utility";

export default class Spm_bdm_accounts extends LightningElement {
    userId = USER_ID;
    BDMAccounts = [];
    ...
    @wire(getBDMAccountStats, { currentUser: '$currentUser', financialYear: '$financialYear', searchTerm: '$searchKeyWord' })
