...
import getBDMTargetDist from '@salesforce/apex/BDDController.getBDMTargetDist';
import getBDDStats from '@salesforce/apex/BDDController.getBDDStats';
import saveBDMTargetConfigs from '@salesforce/apex/BDDController.saveBDMTargetConfigs';

import { showError, showSuccess, nFormatter, currencyFormatter } from "c/spm_utility";

export default class spm_bdd_home extends LightningElement {
    userId = USER_ID;
    ...
    fetchStats() {
        this.isLoading = true;
        getBDDStats({ selYear: this.selYear })
            .then(result => {
    ...
    handleShowPendingTarget(){
        this.showPendingTarget = false;
        location.reload();
    }
